...
//const App = () => {
//  const [currency1, setCurrency1] = useState('');
//  const [selectedCurrencies1, setSelectedCurrencies1] = useState({ 'source': '', 'quotes': { key: '', value: '' } });
//  const [sourceAmount, setSourceAmount] = useState('');
//  const [exchangedAmount, setExchangedAmount] = useState('');

//  useEffect(() => {
//    const fetchCurrencyQuotes = () => {
//      fetch(`http://api.exchangerate.host/live?access_key=abf1dddac1eefc926c0c3d740c0ddec4&currencies=${currency1}`)
//        .then(response => response.json())
//        .then(data => {
//          if (data.success) {
//            const selectedCurrencies1 = Object(data.quotes);
//        setSelectedCurrencies1(selectedCurrencies1);
//      } else {
//        console.error('Invalid API response:', data);
//      }
//    })
...
//  const handleCurrencyClick1 = (currency1) => {
//    if (currency1 === selectedCurrencies1.source) {

//    setCurrency1(currency1);
//    setSelectedCurrencies1(prevState => ({ ...prevState, quotes: currency1 }));
//    }
//  };

//  const handleExchange = () => {
//    if (selectedCurrencies1.length > 0) {
//      const quoteValue = selectedCurrencies1.find(quotes => quotes.includes(selectedCurrencies1.target));
//      const exchangedAmount = sourceAmount * quoteValue;
//      setExchangedAmount(exchangedAmount);
//    }
//  };
//console.log(5+2);
//console.log(handleExchange(selectedCurrencies1.target));
...
//        <label>From:</label>
//        <div>
//          <button onClick={() => handleCurrencyClick1('EUR')}>EUR</button>
//          <button onClick={() => handleCurrencyClick1('USD')}>USD</button>
//          <button onClick={() => handleCurrencyClick1('GBP')}>GBP</button>
//          <button onClick={() => handleCurrencyClick1('JPY')}>JPY</button>
//          <button onClick={() => handleCurrencyClick1('AUD')}>AUD</button>
//          <button onClick={() => handleCurrencyClick1('CAD')}>CAD</button>
//          <button onClick={() => handleCurrencyClick1('CHF')}>CHF</button>
//        </div>
//      </div>
//      <div>
//        <label>Amount:</label>
...
//      {exchangedAmount !== '' && (
//        <div>
//          <p>{`${sourceAmount} ${currency1} = ${exchangedAmount} ${currency1}`}</p>
//        </div>
//      )}
//    </div>
//  );
...
//  const [currency1, setCurrency1] = useState('');
//  //const [currency2, setCurrency2] = useState('');
//  const [selectedCurrencies1, setSelectedCurrencies1] = useState({ source: '', target: '' });
//  //const [selectedCurrencies2, setSelectedCurrencies2] = useState({ source: '', target: '' });
//  const [sourceAmount, setSourceAmount] = useState('');
//  const [exchangedAmount, setExchangedAmount] = useState('');
...
//      .then(data => {
//        if (data.quotes) {
//          const selectedCurrencies1 = Object.keys(data.quotes);
//          setCurrency1(selectedCurrencies1[0]);
...
//  function handleCurrencyClick1(currency1) {
//    setCurrency1(currency1);
//    setSelectedCurrencies1({ source: currency1});
//  }

//  //function handleCurrencyClick2(currency) {
//  //  setCurrency2(currency);
//  //  setSelectedCurrencies2({ source: currency});
//  //}

//  const handleExchange = () => {
//    if (selectedCurrencies1.source) {

//      console.log(selectedCurrencies1.target);
//      const quoteValue = selectedCurrencies1.target;
//      const exchangedAmount = sourceAmount * quoteValue;
//      setExchangedAmount(exchangedAmount);
//    }
...
//        <label>To:</label>
//        <div>
//        <button onClick={() => handleCurrencyClick2('EUR')}>EUR</button>
//        <button onClick={() => handleCurrencyClick2('USD')}>USD</button>
//        <button onClick={() => handleCurrencyClick2('GBP')}>GBP</button>
//        <button onClick={() => handleCurrencyClick2('JPY')}>JPY</button>
//        <button onClick={() => handleCurrencyClick2('AUD')}>AUD</button>
//        <button onClick={() => handleCurrencyClick2('CAD')}>CAD</button>
//        <button onClick={() => handleCurrencyClick2('CHF')}>CHF</button>
//      </div>
//      </div>*/}
//      <div>
//        <label>Amount:</label>
//        <input type="number" value={sourceAmount} onChange={(e) => setSourceAmount(e.quotes.value)} />
//      </div>
//      <button onClick={handleExchange}>Exchange</button>
//      {exchangedAmount !== '' && (
//  <div>
//    <p>{`${sourceAmount} ${handleCurrencyClick1} = ${exchangedAmount} ${handleCurrencyClick1}`}</p>
//  </div>
//)}
...
//  <button key={currency} onClick={() => setSelectedCurrencies({ ...selectedCurrencies, target: quotes[currency] })}>{currency}</button>
//))}
...
//  useEffect(() => {
//    fetch('http://api.exchangerate.host/live?access_key=abf1dddac1eefc926c0c3d740c0ddec4&currencies=USD,EUR,GBP,JPY')
//      .then(response => response.json())
//      .then(data => {
//        const quotes = {};
//        for (const currency in data.quotes) {
//          quotes[currency] = parseFloat(data.quotes[currency]);
//        }
//        setQuotes(quotes);
//      })
//      .catch(error => {
...
//    setSum(event.quotes.value);
//  }

//  function handleFormChange(event) {
//    setFormData({
//      ...formData,
//      [event.quotes.name]: event.quotes.value
//    });
//  }
...
//      const ratio = quotes[currency2] / quotes[currency1];
...
//    if (currency1 && currency2 && sum) {
//      const ratio = quotes[currency2] / quotes[currency1];
//      const result = ratio * parseFloat(sum);
...
//        <button onClick={() => handleCurrencyClick('GBP')}>GBP</button>
//        <button onClick={() => handleCurrencyClick('JPY')}>JPY</button>
//        <button onClick={() => handleCurrencyClick('RUB')}>RUB</button>
//      </div>
...
//      <div>
//        <p>Price Ratio: {calculateRatio()}</p>
...
//        <textarea name="message" value={formData.message} onChange={handleFormChange} placeholder="Message"></textarea>
